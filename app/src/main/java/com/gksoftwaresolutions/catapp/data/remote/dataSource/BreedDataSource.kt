...
class BreedDataSource(
...
) : PageKeyedDataSource<Int, BreedItem>() {

    companion object {
        private const val TAG = "BreedDataSource"
    }
    ...
    override fun loadInitial(
        ...
        callback: LoadInitialCallback<Int, BreedItem>
    ) {
        networkState.postValue(NetworkState.LOADING)
        Common.PARAMS["page"] = "$page"
        Common.PARAMS["limit"] = "${Common.POST_PER_PAGE}"
        disposable.add(
            client.breedsList(Common.PARAMS)
    ...
    override fun loadBefore(params: LoadParams<Int>, callback: LoadCallback<Int, BreedItem>) {

    }

    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, BreedItem>) {
        networkState.postValue(NetworkState.LOADING)
        page = params.key
